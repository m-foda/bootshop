...
$pricesrch=productclass::getByPrice($price,$catid);///////////////////////price search
?>
<!DOCTYPE html>
<html lang="en">
  <head>
...
<!-- Sidebar ================================================== -->
  <div id="sidebar" class="span3">
    <div class="well well-small"><a id="myCart" href="product_summary.php"><img src="themes/images/ico-cart.png" alt="cart"> <?php echo $cart_number; ?> Items in your cart  <span class="badge badge-warning pull-right"><?php echo '$ '.$user_credit; ?></span></a></div>
    <?php
 ...
 <?php
   echo '<div class="tab-pane  active" id="blockView">';
    echo ' <ul class="thumbnails">';
     for ($i = 0; $i < $pricesrch->num_rows; $i++) {
         $row = $pricesrch->fetch_assoc();
       echo'<li class="span3">';
        ...
        echo '<a href="product_details.php?product_id='.$row['product_id'].'&&category_id='.$row['subcat_id'].'"><img src="'.$row['pic_path'].'" /></a>';
         echo'<div class="caption">';
           ...
           echo ' class="btn" href="addToCart.php?sourcePage=searc.php&addCartId='.$row['product_id'].'">Add to <i class="icon-shopping-cart"></i></a>';
